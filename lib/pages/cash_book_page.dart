...
import 'package:new_dish_admin_panlel/widgets/cash_book_table_body.dart';
...
class _CashBookState extends State<CashBook> with SingleTickerProviderStateMixin{
        ...
        children: [
          ...
          _isLoading
            ...
            child: ListView.builder(
              ...
              itemCount: 50,
              itemBuilder: (context,index)=>CashBookTableBody(index: index),
            ),
          )
          //     :Center(child: Column(
          //   children: [
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text('Add Cash Book Information',
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _textBuilder(size, 'Details')),
                ],
              ),
