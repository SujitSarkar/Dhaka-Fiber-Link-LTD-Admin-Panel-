...
class _BankBookPageState extends State<BankBookPage> with SingleTickerProviderStateMixin{
  ...
  TextEditingController _accName = TextEditingController(text: '');
  TextEditingController _accNumber = TextEditingController(text: '');
        ...
        children: [
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    _tableHeaderBuilder(size, 'Account number'),
          ...
          _isLoading
            ...
            child: ListView.builder(
              ...
              itemCount: 50,
              itemBuilder: (context,index)=>BankBookTableBody(index: index),
            ),
          )
          //     :Center(child: Column(
          //   children: [
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(child: _textBuilder(size, 'Account Name')),
                  SizedBox(width: size.height*.04),
                  Expanded(child: _textBuilder(size, 'Account Number')),
                ],
              ),
              SizedBox(height: size.height*.04),
              Row(
                children: [
                  Expanded(child: _textBuilder(size, 'Debit')),
                  SizedBox(width: size.height*.04),
                  Expanded(child: _textBuilder(size, 'Credit')),
                ],
              ),
              SizedBox(height: size.height*.04),
