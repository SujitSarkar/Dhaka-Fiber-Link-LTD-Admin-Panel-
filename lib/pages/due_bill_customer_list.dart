...
import 'package:new_dish_admin_panlel/widgets/customer_list_table_body.dart';
import 'package:new_dish_admin_panlel/widgets/due_customer_list_table_body.dart';
        ...
        children: [
          ...
          _isLoading
            ...
            child: ListView.builder(
              ...
              itemCount: 50,
              itemBuilder: (context,index)=>DueCustomerTableBody(index: index),
            ),
          )
          //     :Center(child: Column(
          //   children: [
